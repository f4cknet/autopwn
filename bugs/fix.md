...
> - [`archive/v4/refactor.md §3`](../archive/v4/refactor.md) — v4.0 已落地的目标架构
> - [`archive/v4/rebuild.md §3`](../archive/v4/rebuild.md) — v3.1 → v4.0.dev0 重构历史（v3.1 fix 不回填本文件）
>
> **本文件章节**：
> - §0 阅读指引
...
| **v3.1 时代 fix 的位置** | `archive/v4/rebuild.md §3`（不回填本文件） |
