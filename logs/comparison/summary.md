...
|--------|----------|----------|----------------------|-----------------|
| canary | PARTIAL | PARTIAL | 98484B / 106448B | 2/3 |
| fmtstr1 | PASS | PASS | 56776B / 56798B | 6/6 |
...
- **v4.0**: PARTIAL（106448B, 1235 行）

| 标记 | v3.1 | v4.0 | 一致 |
|------|------|------|------|
| Padding (dynamic) | `3625` | `3442` | ⚠️ |
