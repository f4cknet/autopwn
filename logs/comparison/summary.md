...
|--------|----------|----------|----------------------|-----------------|
| canary | PARTIAL | PARTIAL | 98484B / 129572B | 2/3 |
| fmtstr1 | PASS | PASS | 56776B / 56780B | 6/6 |
...
- **v4.0**: PARTIAL（129572B, 1466 行）

| 标记 | v3.1 | v4.0 | 一致 |
|------|------|------|------|
| Padding (dynamic) | `3625` | `3477` | ⚠️ |
