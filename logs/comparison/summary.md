...
|--------|----------|----------|----------------------|-----------------|
| canary | PARTIAL | PARTIAL | 98484B / 172445B | 2/3 |
| fmtstr1 | PASS | PASS | 56776B / 56783B | 6/6 |
| level3_x64 | PASS | PASS | 16608B / 16599B | 6/6 |
| pie | PASS | PASS | 15661B / 15652B | 7/7 |
| rip | PASS | PASS | 15926B / 15917B | 6/6 |
...
- **v4.0**: PARTIAL（172445B, 1968 行）

| 标记 | v3.1 | v4.0 | 一致 |
|------|------|------|------|
| Padding (dynamic) | `3625` | `3502` | ⚠️ |
