...
> **角色**：v5 的**主索引与流程入口**
> **状态**：`5.0.dev0` 文档基线已建立（当前活动任务：`v5.0.9`；最近完成：`v5.0.8`，2026-09-01）
> **配套文档**：
...
- **当前活动任务**：`v5.0.9` — 统一 verifier 主体切片（probe/spec 抽象）
...
| ID | 摘要 | 状态 | 预估 | Owner | 详情 |
|---|---|---|---|---|---|
| `v5.0.9` | 统一 verifier 主体切片（probe/spec 抽象） | 🔄 | 2h | @Minzhi_Zhou | [`v5.0.9`](./upgraded/v5.0.9.md) |
