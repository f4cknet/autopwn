...
|--------|----------|----------|----------------------|-----------------|
| canary | PARTIAL | PARTIAL | 98484B / 105204B | 2/3 |
| fmtstr1 | PASS | PASS | 56776B / 56807B | 6/6 |
...
- **v4.0**: PARTIAL（105204B, 1193 行）

| 标记 | v3.1 | v4.0 | 一致 |
|------|------|------|------|
| Padding (dynamic) | `3625` | `3716` | ⚠️ |
