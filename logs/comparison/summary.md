...
|--------|----------|----------|----------------------|-----------------|
| canary | PARTIAL | PARTIAL | 98484B / 96814B | 2/3 |
| fmtstr1 | PASS | PASS | 56776B / 56882B | 6/6 |
| level3_x64 | PASS | PASS | 16608B / 15944B | 6/6 |
| pie | PASS | PASS | 15661B / 15094B | 7/7 |
| rip | PASS | PASS | 15926B / 15292B | 6/6 |
...
- **v4.0**: PARTIAL（96814B, 1099 行）

| 标记 | v3.1 | v4.0 | 一致 |
|------|------|------|------|
| Padding (dynamic) | `3625` | `3659` | ⚠️ |
