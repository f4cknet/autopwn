...
| fmtstr1 | PASS | PASS | 56776B / 56685B | 6/6 |
| level3_x64 | PASS | PASS | 16608B / 15931B | 6/6 |
| pie | PASS | PASS | 15661B / 15094B | 7/7 |
| rip | PASS | PASS | 15926B / 15279B | 6/6 |
...
- **v4.0**: PARTIAL（129573B, 1466 行）

| 标记 | v3.1 | v4.0 | 一致 |
|------|------|------|------|
| Padding (dynamic) | `3625` | `3432` | ⚠️ |
